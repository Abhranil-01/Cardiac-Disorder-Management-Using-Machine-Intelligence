...
class UserManager(BaseUserManager):
    def create_user(self, email, name, phone_number, password=None, password2=None, is_active=True):
        """
    ...
    def create_superuser(self, email, name, phone_number, password=None):
        ...
        user = self.create_user(
            ...
            name=name,
            phone_number=phone_number,
            is_active=True  # Superusers should always be active
        )
        user.is_admin = True
        user.save(using=self._db)
        return user
...
>>>>>>> 2ce9d6f03c1e132a785fd82146722f2988c331a9
